...
namespace ADSoft.Web.Hubs
{
    public class LotteryResultHub : Hub
    {
        ...
        public void SendLotteryResult(string name, string message)
        {
            ...
            content = "<html><body><div id=\"ketqua\">" + GetSubstringByString("<div id=\"ketqua\">", "<div id=\"ketqua2\">", content)+"</html></body>";

            HtmlDocument doc = new HtmlDocument();
            doc.LoadHtml(content);
            foreach (HtmlNode table in doc.DocumentNode.SelectNodes("/html/body/div/div/table"))
            {
