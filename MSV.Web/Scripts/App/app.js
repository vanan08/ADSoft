...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when('/de', { templateUrl: 'de.html', reloadOnSearch: false });
    $routeProvider.when('/lo', { templateUrl: 'lo.html', reloadOnSearch: false });
